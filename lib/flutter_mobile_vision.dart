...
class FlutterMobileVision {
  ...
  static const Size PREVIEW = const Size(1920, 1080);
  ...
  static Future<List<OcrText>> read({
    ...
    //print(list[0]['value']); //TO DO salo agregar consumo del servicio con future
    //print(list.map((map) =>map['value'])); //TO DO salo agregar consumo del servicio con future
    
    return list.map((map) => OcrText.fromMap(map)).toList();//map; regresa un tipo json "value" es lo reconocido
  }
